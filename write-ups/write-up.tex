...
\begin{align*}
	...
	& +\beta_{f} (\eta A_d (1 - R) K )v_{Y}+\frac{1}{2}\varsigma^{2}(\eta A_d  (1 - R) K)^{2}v{}_{YY} \\
	&- [\{\gamma_{1}+\gamma_{2}Y_{t} + \gamma_3 (Y_t - 2) \mathcal{I}\{ Y_t>2\} \}\beta_{f}(\eta A_d(1 - R)K)+\frac{\gamma_2 + \gamma_3 \mathcal{I}\{Y_t > 2\}}{2}\varsigma^{2}(\eta A_d (1 - R) K)^{2}]\\
...
\begin{align*}
	...
	mc =& \cfrac{K}{L} \varphi v_\lambda
\end{align*}

\begin{align*}
	mc  =& (1 - \phi_d i_d) \left(( v_k - R v_r \right) &\Rightarrow i_d &= \frac{1}{\phi_d} \left[ 1 -\frac{K}{L} \frac{ \varphi v_\lambda}{v_k  - R v_r }\right] \\
	mc =& (1 - \phi_g i_g) \left(v_k + (1 - R) v_l\right) &\Rightarrow i_g &= \frac{1}{\phi_g}\left[1 - \frac{K}{L}\frac{\varphi v_\lambda}{v_k + (1 - R) v_r}\right]
\end{align*}

\begin{align*}
	i_\lambda = (A_d - (\frac{1}{\phi_d} - \frac{K}{L} \frac{\varphi}{\phi_d}\frac{v_\lambda}{v_k - R v_r}) ) (1-R) + (A_g - (\frac{1}{\phi_g} - \frac{K}{L}\frac{\varphi}{\phi_g}\frac{v_\lambda}{v_k + (1 - R)v_r }) ) R - \frac{L\delta}{K \varphi v_\lambda}
\end{align*}
