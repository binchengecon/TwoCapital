...
\begin{align*}
	\dif L =& \dif (\log K_g - \log K_d) = \left( (\alpha_g + i_g  - \frac{\phi_{g}}{2}i_g^2 - \frac{|\sigma_g|^2}{2}) -  (\alpha_d + i_d - \frac{\phi_d}{2} i_d^2 - \frac{|\sigma_d|^2}{2})\right) \dif t  + (\sigma_g - \sigma_d) \dif W\\
	\dif \exp(L) =&  \exp(L) \left( \dif L\right) + \frac{\exp(L)}{2} |\sigma_d - \sigma_g|^2 \dif t\\
	\dif R = 
\end{align*}
